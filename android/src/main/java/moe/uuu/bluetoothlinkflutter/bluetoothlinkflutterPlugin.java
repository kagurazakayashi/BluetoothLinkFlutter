package moe.uuu.bluetoothlinkflutter;
 ...
 * @version 1.0.0
 */
public class bluetoothlinkflutterPlugin implements FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    ...
    public bluetoothlinkflutterPlugin() {
    }
